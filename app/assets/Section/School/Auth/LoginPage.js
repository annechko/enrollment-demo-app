                  ...
                  <CCard className="p-4">
                    <CCardBody>
                      <CForm method="post" id={formId} onSubmit={onSubmit}>
                        <h1>Login</h1>
                        <p className="text-medium-emphasis">Sign in to your school account or use the default one</p>
                        <p className="text-medium-emphasis">school@example.com, password: school</p>
