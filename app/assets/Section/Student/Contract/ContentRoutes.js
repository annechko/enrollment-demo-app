...
const LoginPage = React.lazy(async () => await import('../Auth/LoginPage')) // todo rename all, remove Page.
...
const Application = React.lazy(async () => await import('../Application/Application'))
